export const Footer = () => {
  return (
    <>
      <footer className="max-w-screen-xl lg:mx-auto sm:mx-4 flex flex-col gap-8 text-center h-fit rounded-xl m-4 font-titles p-4 items-center bg-transparent border-2 text-white border-gray-700">
        <div>
          <svg
            width="50"
            height="50"

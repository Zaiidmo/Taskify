...
export const TaskCard = ({ border, title, description, taskId, updateTasks }) => {
  // Make Task Done
  ...
  return (
    <div className={`${border} bg-gray-800 border border-white p-4 font-poppins rounded-lg shadow-lg`}>
